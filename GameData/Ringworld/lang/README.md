...
1. Install the [current release](https://github.com/HebaruSan/Ringworld/releases/latest) if you have not already
2. Open your `Kerbal Space Program/GameData/Ringworld/lang` folder on your local disk
...
2. Navigate to the [lang folder](https://github.com/HebaruSan/Ringworld/tree/master/lang)
